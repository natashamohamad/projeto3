...
// LOCAL TEST PARAM
const localTestParam = 'JSvEyAogeImhnLAP'; // &xtest=JSvEyAogeImhnLAP

// PARAM LIST
const paramList: Record<string, string> = {
  'Zkxidj6qY8JKKyK': 'new', // LEGACY CAT PARAM // &cat=Zkxidj6qY8JKKyK
  'KPTSqxgasIkXDoN': 'new', // &xcat=KPTSqxgasIkXDoN
};
